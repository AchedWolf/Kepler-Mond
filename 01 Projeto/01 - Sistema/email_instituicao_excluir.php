...
if($_SESSION['logado']==1)
{
	...
	$justificativa=$linha_inst['justificativa_exc'];
	...
	$assunto = 'Sistema Kepler - Não Aprovação da Instituição de Ensino '.$nome_instituicao;
	$mensagem = '
									<html lang = "pt-br">
									<head>
										<meta charset = "utf-8">
										...
										<div id = "mae" style = "background-color: white;
											...
											<div id = "corpo_email" style = "width: 700px;
												...
												<div style="text-align:justify;line-height:1.5;width:610px">
													Informamos que a Instituição de Ensino <b>'.$nome_instituicao.'</b> não foi aprovada pelos administradores do sistema.
												</div>
												...
												<br>
												<div style="text-align:justify;line-height:1.5;width:610px">
													Para mais informações, entre em contato com o suporte técnico por meio do e-mail <b>projeto.kepler@gmail.com</b>.
												</div>
