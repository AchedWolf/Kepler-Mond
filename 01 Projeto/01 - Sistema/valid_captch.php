<?php
   ...
   header("Content-type: image/jpeg"); // define o tipo do arquivo
    ...
    function captcha($largura,$altura,$tamanho_fonte,$quantidade_letras){
        ...
        $palavra = substr(str_shuffle("AaBbCcDdEeFfGgHhIiJjKkLlMmNnPpQqRrSsTtUuVvYyXxWwZz0123456789"),0,($quantidade_letras)); 
    ...
    $largura = $_POST['largura']; // recebe a largura
    $altura = $_POST['altura']; // recebe a altura
    $tamanho_fonte = $_POST['tam_fonte']; // recebe o tamanho da fonte
    $quantidade_letras = $_POST['qtd_letras']; // recebe a quantidade de letras que o captcha terá
