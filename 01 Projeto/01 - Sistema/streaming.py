	...
	#ABRE IF UM
		...
		#ABRE IF 2
			...
			if(flag_vazio == 0):
				if(now.minute < 50):
					tempo = 50 - now.minute
					r = subprocess.call("ffmpeg -f alsa -ac 1 -i hw:1,0 -f v4l2 -s 1280x720 -r 10 -i /dev/video0 -t 00:"+str(tempo)+":00.000 -vcodec libx264 -pix_fmt yuv420p -preset ultrafast -r 25 -g 20 -b:v 2500k -codec:a libmp3lame -ar 44100 -threads 6 -b:a 11025 -bufsize 512k -f flv rtmp://a.rtmp.youtube.com/live2/edes-gvuh-xa7q-9zje", shell=True)
			else:
