...
def checagem ():
	...
	while(flag):						# Recursividade para verificacao de dados
		...
		if(len(dados_sep) == 8):
			if(dados_sep[0] == 'W' and dados_sep[1] == 'P' and dados_sep[2] == 'Az' and is_number(dados_sep[3]) and is_number(dados_sep[4]) and dados_sep[5] == 'El' and is_number(dados_sep[6]) and is_number(dados_sep[7])):
